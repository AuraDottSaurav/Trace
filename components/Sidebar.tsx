    ...
    return (
        ...
        >
            ...
            <div className="p-4 border-t border-slate-200 dark:border-slate-800 w-full mb-2">
                <div className={classNames("bg-white dark:bg-slate-800 rounded-xl p-3 border border-slate-200 dark:border-slate-700 shadow-sm flex items-center overflow-hidden mb-4", collapsed ? "justify-center p-2 mx-auto w-10 h-10" : "gap-3")}>
